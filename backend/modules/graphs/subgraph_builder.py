...
def retrieval_workflow_builder(config: Settings = settings) -> StateGraph:
    """
    ...
    retrieval_workflow.add_node("retrieve", config_nodes(retrieve, config))
    retrieval_workflow.add_node("retrieval_grader", config_nodes(retrieval_grader, config))
    retrieval_workflow.add_node("refine_question", config_nodes(refine_question, config))
    retrieval_workflow.add_node("generate_retrieval_answer", config_nodes(generate_retrieval_answer, config))
    retrieval_workflow.add_node("cannot_answer_retrieval_task", config_nodes(cannot_answer_retrieval_task, config))
